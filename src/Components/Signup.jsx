...
const validate = () => {
  ...
  if (!/^[A-Za-z]{2,}$/.test(lastName)) {
    temp.lastName = "Enter a valid last name (letters only)";
  }
  ...
  return Object.keys(temp).length === 0; // returns true if no errors
};
...
const handleSubmit = (e) => {
  ...
  return (
    <div className="fixed right-0 top-0 h-150 w-[420px] mr-8 mt-12  bg-white shadow-2xl p-6 overflow-y-auto rounded-4xl">
...
>
  <RxCross2 />
      ...
      <form className="grid grid-cols-2 gap-4"
        ...
        <label className="flex flex-col">
          ...
          <input className="p-2 border rounded-2xl" type="text" 
  ...
  <p className="text-red-600 text-sm">{errors.lastName}</p>
        ...
        <label className="flex flex-col">
          ...
          <input className="p-2 border rounded-2xl" type="email"
  ...
  <p className="text-red-600 text-sm">{errors.email}</p>
        ...
        <label className="flex flex-col">
          ...
          <input className="p-2 border rounded-2xl" type="tel"
  ...
  <p className="text-red-600 text-sm">{errors.mobile}</p>
        ...
        <label className="col-span-2 flex flex-col">
          ...
          <input className="p-2 border  rounded-xl w-70 " type="password" 
  ...
  <p className="text-red-600 text-sm">{errors.confirmPassword}</p>
           ...
           <button type="submit" className="w-40 bg-orange-700 text-white py-2 rounded-3xl mt-6 ml-26 hover:bg-purple-800">
        Sign Up
      </button>
